...
printf "Begin Ubuntu 18.04 x86_64 Setup\n"
printf "\n\nThis sets up the machine for use as a server or a workstation\n"
printf "You may wish to run server.sh or workstation.sh next!\n"
